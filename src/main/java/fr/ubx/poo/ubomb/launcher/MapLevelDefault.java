...
public class MapLevelDefault extends MapLevel {
    private final static Entity[][] level1 = {
            ...
            {Empty, Empty, Monster, Empty, Empty, Empty, Empty, Key, Empty, Stone, Empty, Empty},
            ...
            {Empty, Empty, Empty, BombNumberDec, BombNumberInc, Empty, Empty, Monster, Empty, Empty, Empty, Empty},
            {Empty, Empty, Empty, BombNumberDec, BombNumberInc, Empty, Empty, Empty, Empty, Monster, Empty, Princess}
    };
